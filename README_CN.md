...
| 环境变量名                     | 说明                                                                  | 默认值                               | 是否必需 | 备注                                                                                               |
| :----------------------------- | :-------------------------------------------------------------------- | :----------------------------------- | :------- | :------------------------------------------------------------------------------------------------- |
| `BAIDU_APP_ID`                 | 百度翻译 appid                                                          | `''`                                 | 否       |                                                                                                    |
| `BAIDU_SECRET_KEY`             | 百度翻译密钥                                                            | `''`                                 | 否       |                                                                                                    |
| `YOUDAO_APP_KEY`               | 有道翻译应用 ID                                                          | `''`                                 | 否       |                                                                                                    |
| `YOUDAO_SECRET_KEY`            | 有道翻译应用秘钥                                                          | `''`                                 | 否       |                                                                                                    |
| `DEEPL_AUTH_KEY`              | DeepL 翻译 AUTH_KEY                                                       | `''`                                 | 否       |                                                                                                    |
| `OPENAI_API_KEY`              | OpenAI API 密钥                                                        | `''`                                 | 否       |                                                                                                    |
| `OPENAI_MODEL`                | OpenAI 模型 (可选)                                                      | `''`                                 | 否       |                                                                                                    |
| `OPENAI_HTTP_PROXY`           | OpenAI HTTP 代理 (可选)                                                | `''`                                 | 否       | 替代 `--proxy`                                                                                      |
| `OPENAI_GLOSSARY_PATH`        | OpenAI 术语表路径 (可选)                                                  | `./dict/mit_glossory.txt`            | 否       |                                                                                                    |
| `OPENAI_API_BASE`             | OpenAI API 基础地址 (可选)                                                | `https://api.openai.com/v1`          | 否       | 默认为官方地址                                                                                       |
|`GROQ_API_KEY`| Groq API 密钥 ||否||
| `SAKURA_API_BASE`             | SAKURA API 地址 (可选)                                                  | `http://127.0.0.1:8080/v1`           | 否       |                                                                                                    |
| `SAKURA_VERSION`               | SAKURA API 版本 (可选)                                                    | `'0.9'`                              | 否       | `0.9` 或 `0.10`                                                                                    |
| `SAKURA_DICT_PATH`            | SAKURA 术语表路径 (可选)                                                  | `./dict/sakura_dict.txt`             | 否       |                                                                                                    |
| `CAIYUN_TOKEN`                | 彩云小译 API 访问令牌                                                      | `''`                                 | 否       |                                                                                                    |
| `DEEPSEEK_API_KEY`           | DeepSeek API 密钥                                                         | `''`                                 | 否      |                                                                                                       |
| `DEEPSEEK_API_BASE`           | DeepSeek API 基础地址（可选）                                              |   `https://api.deepseek.com`                                                              | 否      |   |
| `CUSTOM_OPENAI_API_KEY`        | 自定义 OpenAI API 密钥 (Ollama 不需要，但其他工具可能需要)                   | `'ollama'`                            | 否       |                                                                                                    |
| `CUSTOM_OPENAI_API_BASE`       | 自定义 OpenAI API 基础地址 (使用 OLLAMA_HOST 环境变量更改绑定 IP 和端口)     | `http://localhost:11434/v1`          | 否       |                                                                                                    |
| `CUSTOM_OPENAI_MODEL`          | 自定义 OpenAI 模型 (例如 "qwen2.5:7b"，确保在使用前拉取并运行它)             | `''`                                 | 否       |                                                                                                    |
| `CUSTOM_OPENAI_MODEL_CONF`     | 例如 "qwen2"                                                              | `''` | 否       |                                                                                                       |
